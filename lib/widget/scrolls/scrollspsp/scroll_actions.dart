...
class ScrollActions extends StatelessWidget {
  const ScrollActions({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: actionData.listaAction.length,
        itemBuilder: (BuildContext context, index) {
          Map<dynamic, dynamic> imageData = actionData.listaAction[index];
          return ImagenAction(imageData: imageData);
        },
      ),
    );
  }
...
class ImagenAction extends StatefulWidget {
  ...
  const ImagenAction({Key? key, required this.imageData}) : super(key: key);

  // Método que crea el estado asociado a este widget.
  @override
  ImagenActionState createState() => ImagenActionState();
}

// Clase que representa el estado del widget ImagenTop.
class ImagenActionState extends State<ImagenAction>
    ...
    return GestureDetector(
      ...
      onTapUp: (_) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => InfoAction(imageData: widget.imageData),
          ),
        );
      },
      onTapCancel: () {
...
class InfoAction extends StatelessWidget {
  ...
  const InfoAction({Key? key, required this.imageData}) : super(key: key);
