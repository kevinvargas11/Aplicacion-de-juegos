...
class ScrollDeporte extends StatelessWidget {
  const ScrollDeporte({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    DeporteData deporteData = DeporteData();
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: deporteData.listaDeportes.length,
        itemBuilder: (BuildContext context, index) {
          Map<dynamic, dynamic> imageData = deporteData.listaDeportes[index];
          return ImagenDeportes(imageData: imageData);
        },
      ),
    );
  }
...
class ImagenDeportes extends StatefulWidget {
  ...
  const ImagenDeportes({Key? key, required this.imageData}) : super(key: key);

  // Método que crea el estado asociado a este widget.
  @override
  ImagenDeporteState createState() => ImagenDeporteState();
}

// Clase que representa el estado del widget ImagenTop.
class ImagenDeporteState extends State<ImagenDeportes>
    ...
    return GestureDetector(
      ...
      onTapUp: (_) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => InfoDeporte(imageData: widget.imageData),
          ),
        );
      },
      onTapCancel: () {
...
class InfoDeporte extends StatelessWidget {
  ...
  const InfoDeporte({Key? key, required this.imageData}) : super(key: key);
