...
class ScrollCarreras extends StatelessWidget {
  const ScrollCarreras({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    CarreraData carreraData = CarreraData();
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: carreraData.listaCarrera.length,
        itemBuilder: (BuildContext context, index) {
          Map<dynamic, dynamic> imageData = carreraData.listaCarrera[index];
          return ImagenCarrera(imageData: imageData);
        },
      ),
    );
  }
...
class ImagenCarrera extends StatefulWidget {
  ...
  const ImagenCarrera({Key? key, required this.imageData}) : super(key: key);

  // Método que crea el estado asociado a este widget.
  @override
  ImagenCarreraState createState() => ImagenCarreraState();
}

// Clase que representa el estado del widget ImagenTop.
class ImagenCarreraState extends State<ImagenCarrera>
    ...
    return GestureDetector(
      ...
      onTapUp: (_) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => InfoCarrera(imageData: widget.imageData),
          ),
        );
      },
      onTapCancel: () {
...
class InfoCarrera extends StatelessWidget {
  final Map<dynamic, dynamic> imageData;

  const InfoCarrera({Key? key, required this.imageData}) : super(key: key);
