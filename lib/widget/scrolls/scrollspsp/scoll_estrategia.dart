...
class ScrollEstrategia extends StatelessWidget {
  const ScrollEstrategia({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    EstrategiaData estrategiaData = EstrategiaData();
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: estrategiaData.listaEstrategia.length,
        itemBuilder: (BuildContext context, index) {
          Map<dynamic, dynamic> imageData =
              estrategiaData.listaEstrategia[index];
          return ImagenEstrategia(imageData: imageData);
        },
      ),
    );
  }
...
class ImagenEstrategia extends StatefulWidget {
  ...
  const ImagenEstrategia({Key? key, required this.imageData}) : super(key: key);

  // Método que crea el estado asociado a este widget.
  @override
  ImagenEstrategiaState createState() => ImagenEstrategiaState();
}

// Clase que representa el estado del widget ImagenTop.
class ImagenEstrategiaState extends State<ImagenEstrategia>
    ...
    return GestureDetector(
      ...
      onTapUp: (_) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => InfoEstrategia(imageData: widget.imageData),
          ),
        );
      },
      onTapCancel: () {
...
class InfoEstrategia extends StatelessWidget {
  final Map<dynamic, dynamic> imageData;

  const InfoEstrategia({Key? key, required this.imageData}) : super(key: key);
